...
// STDbKit
#define COCOAPODS_POD_AVAILABLE_STDbKit
#define COCOAPODS_VERSION_MAJOR_STDbKit 1
#define COCOAPODS_VERSION_MINOR_STDbKit 0
#define COCOAPODS_VERSION_PATCH_STDbKit 0
